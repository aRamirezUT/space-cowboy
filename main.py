...
class Menu:
    ...
    def setup_fonts(self) -> None:
        ...
        if not f:
            self.font_small: pygame.font.Font = pygame.font.SysFont("monospace", 22)
            self.font_big: pygame.font.Font = pygame.font.SysFont("monospace", 48)
        self.font_small: pygame.font.Font = f.small
        self.font_big: pygame.font.Font = f.big
    ...
    # Should be overriden by games that support restarting
