...
USE_BLUETOOTH = True  # Set to True/False to toggle Bluetooth input globally
...
class ControlsMixin:
    ...
    def read_ble_channels(self) -> Tuple[Tuple[float, float], Tuple[float, float]]:
        """TEMPLATE: Read two BLE channels per device.

        Returns a tuple of two devices, each as (ch1, ch2) floats:
            ((p1_ch1, p1_ch2), (p2_ch1, p2_ch2))

        Override this in your game to return real channel values.
        """
