...
class TwinSunsDuel:
    ...
    def _draw(self):
        ...
        self.left_player.draw(self.scene, facing_right=True, fg_color=FG_COLOR, accent=ACCENT)
        self.right_player.draw(self.scene, facing_right=True, fg_color=FG_COLOR, accent=ACCENT)
